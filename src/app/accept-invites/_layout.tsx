...
export default function AcceptsLayout({ children,  }: { children: React.ReactNode}) {
    ...
    <div className="flex xl:gap-32 gap-10 min-h-screen w-full xl:px-7 md:py-5 sm:px-10 px-5">
      ...
      {/* Right side - Form content */}
        <div className="flex flex-col xl:pr-10 mx-auto lg:px-0 w-[700px]">
          <div className="flex flex-col items-center justify-center  pb-12 w-full lg:-mt-24 w-[80%]">
