      ...
      <div className="min-h-full flex h-screen bg-white">
        <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            ...
            <div className="mt-8">
              <div className=" text-center grid grid-cols-1 gap-4 pb-7 md:grid-cols-2 xl:gap-5 xl:pb-8">
                <button className="flex justify-center items-center flex-col py-2 outline-none">
